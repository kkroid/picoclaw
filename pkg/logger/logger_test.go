...
func TestConfigureFromEnv(t *testing.T) {
	...
	tmpFile := "/tmp/oneappfactory_test_log_" + fmt.Sprintf("%d", time.Now().UnixNano())
	defer os.Remove(tmpFile)

	os.Setenv("ONEAPPFACTORY_LOG_FILE", tmpFile)
	defer os.Unsetenv("ONEAPPFACTORY_LOG_FILE")
	...
	os.Setenv("ONEAPPFACTORY_LOG_FILE", "~/test_log")
	ConfigureFromEnv()
...
func TestConfigureFromEnvNoEnv(t *testing.T) {
	os.Unsetenv("ONEAPPFACTORY_LOG_FILE")
	ConfigureFromEnv()
}
