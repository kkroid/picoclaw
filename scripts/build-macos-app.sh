#!/bin/bash
# Build macOS .app bundle for OneAppFactory Launcher
...
APP_NAME="OneAppFactory Launcher"
APP_PATH="./build/${APP_NAME}.app"
APP_CONTENTS="${APP_PATH}/Contents"
APP_MACOS="${APP_CONTENTS}/MacOS"
APP_RESOURCES="${APP_CONTENTS}/Resources"
APP_EXECUTABLE="oneappfactory-launcher"
...
if [ -f "./build/oneappfactory" ]; then
    cp "./build/oneappfactory" "${APP_MACOS}/"
else
    echo "Error: ./build/oneappfactory not found. Please build the main file first."
    echo "Run: make build"
    exit 1
fi
chmod +x "${APP_MACOS}/"*
...
<dict>
    ...
    <string>oneappfactory-launcher</string>
    <key>CFBundleIdentifier</key>
    <string>com.oneappfactory.launcher</string>
